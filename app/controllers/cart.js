...
const emailSend = require('../config/email') //no necesario por ahora
const { cart } = require('../models') //solicito info del model de cart

exports.getCart = async (req, res) => {
    //200: se pudo obtener lo solicitado
    //400: no se encontro
    let cart = res.cart
    try {
...
//logica y control de carrito con productos agregado
